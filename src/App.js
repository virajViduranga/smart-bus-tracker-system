...
import { Crosshair } from 'lucide-react'; // Icon for location button
...
export default function App() {
  ...
  // iOS Fix: Location request must be triggered by user action
  ...
  // Try once on load (might fail on iOS, but works on Android/Desktop)
  useEffect(() => {
