  ...
  <div className="absolute top-0 left-0 right-0 z-20 pointer-events-none">
    ...
    <div className="pt-14 px-6 pointer-events-auto relative z-10">
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <button
          onClick={onLogout}
          className="w-10 h-10 bg-white/90 backdrop-blur-md rounded-full shadow-lg 
      ...
      {/* Search bar */}
      <div className="bg-white p-2 rounded-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)] 
                      flex items-center transform transition-transform hover:scale-[1.02]">
        ...
        <input
          ...
          className="w-full p-4 outline-none text-gray-800 font-medium text-lg 
